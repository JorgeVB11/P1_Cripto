...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\jvina\Criptografia_y_Seguridad\p1_cripto\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\jvina\Criptografia_y_Seguridad\p1_cripto\venv\Scripts\deactivate.nu'
